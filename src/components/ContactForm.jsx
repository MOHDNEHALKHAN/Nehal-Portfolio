...
function ContactForm() {
    useGSAP(() => {
        ...
        return (
            <div id="contactform" className="  flex flex-col px-5 lg:px-10 xl:px-8 py-24 md:py-20 lg:py-20 xl:py-20  w-full bg-[#F3F3E0] overflow-hidden items-center select-none">
                    ...
                    <div className='flex flex-col lg:flex-row xl:flex-row gap-10 '>
                        <div className='flex flex-col gap-9'>
                            <div className='flex flex-col'>
                                ...
                                <input type='text' className='rounded-full py-2 px-5 focus:outline-none focus:border-transparent font-[kanit]' />
                            </div>
                            <div className='flex flex-col'>
                                <label className='font-[Kanit] font-medium text-xl text-slate-600'>Email*</label>
                                < input type='email' className='rounded-full py-2 px-5 focus:outline-none focus:border-transparent font-[kanit]' />
                            </div>
                        </div>
                        <div className='flex flex-col'>
                            <label className='font-[Kanit] font-medium text-xl text-slate-600'>Message*</label>
                            <textarea type='text' className='rounded-3xl py-4 px-3 h-[150px] focus:outline-none focus:border-transparent font-[kanit]' />
                        </div>
                    </div>
                    <div >
